...
<html lang="es">
  ...
  <body>
    ...
    <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
        ...
        <div class="login">
	<h1>REGISTARSE</h1>
    <form class="needs-validation" novalidate  action="registro.php" method="post"  >
      <input type="email" name="EMAIL" placeholder="EMAIL" required="required" /><br>
      <br>
      <input type="text" name="CEDULA" placeholder="CEDULA" required="required" />
      <br>
      <br>
      <input type="password" name="PASSWORD" placeholder="USUARIO" required="required" /><br>
